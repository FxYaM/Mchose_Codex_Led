...
The 1.6.0 local checks on Windows and Node.js 24.19.0 passed **83/83 tests**, checks for 25 CJS files and six PowerShell scripts, and a fresh dependency installation with native-module loading. Hardware behavior was not revalidated for this release: physical unplug/replug, reboot startup, real keyboard readback and live Desktop integration remain separate manual checks. Earlier successful observations do not count as new release verification.
